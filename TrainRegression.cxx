...
//    factory->AddVariable( "std_vector_lepton_phi[1]" , 'F');
   ...
   factory->AddVariable( "dphill*mll" , 'F');
...
//    factory->AddTarget( "higgsLHEmass/mll" ); 
   factory->AddTarget( "higgsLHEmass" ); 
...
//    TString fname = "/media/data/amassiro/LatinoTrees/MrWW/MCl2loose__hadd__l2tight/latino_MassSoup.root";
   TString fname = "/media/data/amassiro/LatinoTrees/MrWW/MCl2loose__hadd__l2tight/latino_MassSoup_flat.root";
   ...
   TTree *regTree = (TTree*)input->Get("latino");
   ...
   factory->SetWeightExpression( "weightMHflat", "Regression" );
